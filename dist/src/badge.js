...
function RadialBadge({
  ...
  }, [1, 2, 3, 4].map((li) => React.createElement("circle", {
    key: li,
    cx,
    cy,
    r: RINGS[li],
  ...
  }), showCenter && (centerLabel != null ? React.createElement("text", {
    x: cx,
    y: cy + size * 0.045,
    textAnchor: "middle",
    fontSize: size * 0.13,
  ...
  }, centerLabel) : React.createElement("g", null, React.createElement("circle", {
    cx,
    cy,
    r: size * 0.04,
    fill: "#f3ece0"
